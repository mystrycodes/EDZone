...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    {name:'My Courses', path:'/instructor/my-courses', icon: assets.my_course_icon},
    {name:'Students Enrolled', path:'/instructor/students-enrolled', icon: assets.person_tick_icon}
  ]
  return isInstructor&&(
